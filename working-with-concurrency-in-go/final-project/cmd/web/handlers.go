...
func (app *Config) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	...
	app.Session.Put(r.Context(), "flash", "succesful login")
	// redirect the user
...
func (app *Config) PostRegisterPage(w http.ResponseWriter, r *http.Request) {
	...
	_, err = u.Insert(u)
	if err != nil {
		app.Session.Put(r.Context(), "error", "unable to create an user")
	...
	app.Session.Put(r.Context(), "flash", "Please check your email")
	http.Redirect(w, r, "/login", http.StatusSeeOther)
...
func (app *Config) generateManual(u data.User, plan *data.Plan) *gofpdf.Fpdf {
	...
	pdf.Ln(5)
	pdf.MultiCell(0, 4, fmt.Sprintf("%s User Guid"), "", "C", false)
